...
public class PhysicsRBody : MonoBehaviour
{
    ...
    //When this function is called, it sets the bounding box around the gameobject
    void SetAABB()
    {
    ...
    //This part of the code gets the deltatime from the physics engine and uses it to calculate
    //the acceleration and velocity of the gameobject
    public void Integrate(float dT)
    {
        //This if statement executes when the object is set to obey gravity and is not touching the ground
        //when it is on the ground, the velocity is set to zero
